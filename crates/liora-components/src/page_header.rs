//! Page Header module.
//!
//! This public module implements the Liora page header component with title, back action, and footer slots. It keeps the reusable
...
impl PageHeader {
    ...
    /// Registers a callback that runs when back occurs.
