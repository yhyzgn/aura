...
impl NotificationManager {
    ...
    pub fn show(title: impl Into<SharedString>, description: Option<SharedString>, msg_type: NotificationType, cx: &mut App) {
        Self::init(cx);
                ...
                div()
                    ...
                    .child(
                        div().flex_1().flex().flex_col().gap_1()
                            ...
                            .when_some(item.description, |s, d| s.child(div().text_sm().text_color(theme.neutral.text_3).child(d)))
                    )
            }))
    }
}

pub fn show_notification(title: impl Into<SharedString>, description: Option<SharedString>, msg_type: NotificationType, cx: &mut App) {
