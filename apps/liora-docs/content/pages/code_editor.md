...
- 支持 `CodeEditorHighlightTheme` 自定义编辑器高亮主题：可覆盖 base `CodeTheme`、surface、chrome/gutter、border、text/muted text、caret、selection、current line、ruler、whitespace、diagnostic semantic colors，以及语法 run 的前景/背景覆盖。
