...
fn docs_status_bar_shell() -> AnyElement {
    docs_status_bar_preview(
        liora_components::StatusBar::new()
            ...
            .right_item(liora_components::StatusBarItem::new("v0.1.20").pill()),
    )
}
...
mod tests {
    ...
    fn packaging_docs_and_workflows_include_release_readiness_gate() {
        ...
        assert!(sdk.contains("liora-theme liora-icons-optimizer liora-core liora-icons liora-icons-lucide liora-icons-antd liora-icons-ionic liora-icons-tabler liora-icons-carbon liora-icons-material liora-components liora-tray liora-packager liora-updater liora"));
    ...
    fn release_candidate_readiness_docs_cover_current_boundaries() {
        ...
        assert!(sdk_workflow.contains("liora-theme liora-icons-optimizer liora-core liora-icons liora-icons-lucide liora-icons-antd liora-icons-ionic liora-icons-tabler liora-icons-carbon liora-icons-material liora-components liora-tray liora-packager liora-updater liora"));
