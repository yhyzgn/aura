...
::AuraDemo{component="SegmentRatioBarBottom"}::
...
::AuraDemo{component="SegmentRatioBarTop"}::
...
::AuraDemo{component="SegmentRatioBarBoth"}::
...
::AuraDemo{component="SegmentRatioBarHidden"}::
...
::AuraDemo{component="SegmentRatioBarPattern"}::
...
::AuraDemo{component="SegmentRatioBarCompact"}::
