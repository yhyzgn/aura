...
将内容固定在特定可视区域中，适合长表单的提交按钮、工具条或需要持续可见的操作入口。Affix 通过 GPUI 布局测量与 Aura PassivePortal 完成固钉，不依赖浏览器定位。
...
::AuraDemo{component="AffixBottom"}::
...
::AuraDemo{component="AffixContainer"}::
