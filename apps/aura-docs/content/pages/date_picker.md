...
::AuraDemo{component="DatePickerBasic"}::
...
::AuraDemo{component="DatePickerFormatted"}::
...
::AuraDemo{component="DatePickerRange"}::
...
::AuraDemo{component="DatePickerMonth"}::
...
::AuraDemo{component="DatePickerMonthRange"}::
...
::AuraDemo{component="DatePickerYear"}::
...
::AuraDemo{component="DatePickerYearRange"}::
...
::AuraDemo{component="DatePickerDisabled"}::
