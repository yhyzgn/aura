...
::AuraDemo{component="SignalMeterMobile"}::
...
::AuraDemo{component="SignalMeterWifi"}::
...
::AuraDemo{component="SignalMeterLevels"}::
...
::AuraDemo{component="SignalMeterThresholdColors"}::
