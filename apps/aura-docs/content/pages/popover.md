...
点击触发后在目标附近渲染原生卡片内容，适合承载少量说明、二级操作或轻量表单。Popover 基于 Aura Portal 与 GPUI 原生元素实现，内容不是 Web 浮层。
...
::AuraDemo{component="PopoverBasic"}::
...
::AuraDemo{component="PopoverPlacements"}::
...
::AuraDemo{component="PopoverCloseStrategy"}::
