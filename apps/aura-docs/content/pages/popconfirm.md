...
::AuraDemo{component="PopconfirmBasic"}::
...
::AuraDemo{component="PopconfirmPlacements"}::
...
危险操作可以自定义按钮文案，并通过 `close_on_escape(false)` 禁止 ESC 关闭，避免误触丢失决策上下文。

### 效果

::AuraDemo{component="PopconfirmCustomText"}::
