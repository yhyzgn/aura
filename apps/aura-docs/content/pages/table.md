...
::AuraDemo{component="TableSortable"}::
...
::AuraDemo{component="TableStripeBorder"}::
...
::AuraDemo{component="TableFixedHeader"}::
...
::AuraDemo{component="TableLoading"}::
