...
use aura_components::{Button, Input, QrCode, Space, toast_error, toast_success};
...
impl QrCodeGenerateDemo {
    fn new(cx: &mut Context<Self>) -> Self {
        Self {
            input: cx.new(|cx| {
                Input::new("https://github.com/yhyzgn/aura", cx)
                    .placeholder("输入要编码的字符串")
                    .clearable(true)
                    .width(px(420.0))
            }),
            generated: "https://github.com/yhyzgn/aura".into(),
        }
    }
}
