//! Basic `VirtualizedList` snippet used by Aura Docs.
//! The list renders native Aura/GPUI rows only when they enter the viewport.

use aura_components::{Space, Tag, Text, VirtualizedList};
