        ...
        div().flex().flex_col().gap_8()
            .child(
                div().flex().flex_col().gap_2()
                    .child(div().text_lg().font_weight(gpui::FontWeight::BOLD).child("Alert 警告"))
                    .child(div().text_sm().text_color(theme.neutral.text_3).child("用于页面中展示重要的提示信息。"))
            )
            .child(
            ...
            .child(
                div().flex().flex_col().gap_2()
                    .child(div().text_lg().font_weight(gpui::FontWeight::BOLD).child("辅助性文字"))
            )
            .child(
                Alert::new("Warning").alert_type(AlertType::Warning).description("More detailed description of the warning.")
            )
    }
}
