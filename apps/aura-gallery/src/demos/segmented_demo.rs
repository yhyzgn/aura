        ...
        div().flex().flex_col().gap_8().p_4()
            .child(
                div().flex().flex_col().gap_2()
                    .child(div().text_lg().font_weight(gpui::FontWeight::BOLD).child("Segmented 分段控制器"))
                    .child(div().text_sm().text_color(theme.neutral.text_3).child("用于展示多个选项并允许用户选择其中单个选项。"))
            )
            .child(
            ...
            .child(
                div().flex().flex_col().gap_4()
                    .child(div().font_weight(gpui::FontWeight::BOLD).child("不可用状态"))
                    .child(
                        cx.new(|_| {
                            Segmented::new(vec![
            ...
            .child(
                div().flex().flex_col().gap_4()
                    .child(div().font_weight(gpui::FontWeight::BOLD).child("Block 模式 (撑满宽度)"))
                    .child(
                        cx.new(|_| {
                            Segmented::new(vec![
