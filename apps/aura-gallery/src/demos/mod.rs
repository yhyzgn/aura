...
pub fn registry() -> Vec<DemoEntry> {
    vec![
        ...
        DemoEntry { name: "Scrollbar 滚动条", description: "原生滚动容器", render: scrollbar_demo::render },
        DemoEntry { name: "Splitter 分隔面板", description: "左右面板分割", render: splitter_demo::render },
