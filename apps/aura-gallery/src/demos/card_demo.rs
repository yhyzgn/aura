        ...
        div().flex().flex_col().gap_8()
            .child(
                div().flex().flex_col().gap_2()
                    .child(div().text_lg().font_weight(gpui::FontWeight::BOLD).child("Card 卡片"))
                    .child(div().text_sm().text_color(theme.neutral.text_3).child("将信息聚合在卡片容器中展示。"))
            )
            .child(
            ...
            .child(
                div().flex().flex_col().gap_2()
                    .child(div().text_lg().font_weight(gpui::FontWeight::BOLD).child("底部操作"))
            )
            .child(
