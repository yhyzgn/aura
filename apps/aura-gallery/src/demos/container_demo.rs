    ...
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        div()
            ...
            .child(div().flex().flex_col().gap_2()
                ...
                .child(div().child("Above divider").child(Divider::new()).child("Below divider"))
                .child(Divider::new().label("Center Label"))
                .child(div().flex().flex_row().items_center().gap_4().h_6()
                    .child("Section 1")
            ...
            .child(div().flex().flex_col().gap_2()
                ...
                .child(div().h(px(300.0)).w_full().border_1().border_color(theme.neutral.border).child(
                    Container::new()
                        .header(div().flex().items_center().child(Title::new("Header").h5()))
