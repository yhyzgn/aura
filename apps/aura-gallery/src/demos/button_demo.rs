...
fn types() -> Vec<impl IntoElement> { vec![
    AuraButton::new("Default"), AuraButton::new("Tertiary").tertiary(),
    AuraButton::new("Primary").primary(), AuraButton::new("Info").info(),
    AuraButton::new("Success").success(), AuraButton::new("Warning").warning(),
    AuraButton::new("Error").danger(),
]}

fn secondary() -> Vec<impl IntoElement> { vec![
    AuraButton::new("Default").secondary(), AuraButton::new("Tertiary").tertiary().secondary(),
    AuraButton::new("Primary").primary().secondary(), AuraButton::new("Info").info().secondary(),
    AuraButton::new("Success").success().secondary(), AuraButton::new("Warning").warning().secondary(),
    AuraButton::new("Error").danger().secondary(),
]}

fn secondary_nb() -> Vec<impl IntoElement> { vec![
...
fn states() -> Vec<impl IntoElement> { vec![
    AuraButton::new("Disabled").primary().disabled(true),
    AuraButton::new("Sec Disabled").primary().secondary().disabled(true),
]}

fn loading_states() -> Vec<impl IntoElement> { vec![
...
fn rounded() -> Vec<impl IntoElement> { vec![
