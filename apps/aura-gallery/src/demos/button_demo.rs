...
fn types(theme: &AuraTheme) -> Vec<impl IntoElement> { vec![
...
fn secondary(theme: &AuraTheme) -> Vec<impl IntoElement> { vec![
...
fn secondary_nb(theme: &AuraTheme) -> Vec<impl IntoElement> { vec![
...
fn sizes(theme: &AuraTheme) -> Vec<impl IntoElement> { vec![
...
fn states(theme: &AuraTheme) -> Vec<impl IntoElement> { vec![
    AuraButton::new("Disabled").primary().disabled(true).build(theme),
    AuraButton::new("Loading").primary().loading(true).build(theme),
    AuraButton::new("Sec Disabled").primary().secondary().disabled(true).build(theme),
]}

fn rounded(theme: &AuraTheme) -> Vec<impl IntoElement> { vec![
