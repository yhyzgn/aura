        ...
        div().flex().flex_col().gap_8().p_4()
            .child(
                div().flex().flex_col().gap_2()
                    .child(div().text_lg().font_weight(gpui::FontWeight::BOLD).child("Breadcrumb 面包屑"))
                    .child(div().text_sm().text_color(theme.neutral.text_3).child("显示当前页面的路径，快速返回之前的页面。"))
            )
            .child(
            ...
            .child(
                div().flex().flex_col().gap_4()
                    .child(div().font_weight(gpui::FontWeight::BOLD).child("自定义分隔符 (String)"))
                    .child(
            ...
            .child(
                div().flex().flex_col().gap_4()
                    .child(div().font_weight(gpui::FontWeight::BOLD).child("自定义分隔符 (Icon)"))
                    .child(
                        Breadcrumb::new().separator_icon(IconName::ChevronRight)
                            .item(BreadcrumbItem::new("首页"))
                            .item(BreadcrumbItem::new("推广管理"))
                            .item(BreadcrumbItem::new("推广列表"))
                            .item(BreadcrumbItem::new("推广详情"))
                ...
                div().flex().flex_col().gap_4()
                    ...
                    .child(
                        Breadcrumb::new()
                            ...
                            .item(BreadcrumbItem::new("推广管理").on_click(|_, _| println!("Management Clicked")))
                            .item(BreadcrumbItem::new("推广列表"))
                    )
            )
    }
