        ...
        div().flex().flex_col().gap_8().p_4()
            .child(
                div().flex().flex_col().gap_2()
                    .child(div().text_lg().font_weight(gpui::FontWeight::BOLD).child("Progress 进度条"))
                    .child(div().text_sm().text_color(theme.neutral.text_3).child("展示操作进度，告知用户当前状态。"))
            )
            .child(
            ...
            .child(
                div().flex().flex_col().gap_4()
                    .child(div().font_weight(gpui::FontWeight::BOLD).child("百分比内显 (TODO)"))
            ...
            .child(
                div().flex().flex_col().gap_4()
                    .child(div().font_weight(gpui::FontWeight::BOLD).child("自定义颜色"))
